...
<script type="text/javascript">
	...
	$(document).ready(function(){
    	...
    	*/    
		...
		frm.action = "<%= ctxPath%>/writePrepareEnd.to";
		frm.submit();
					...
					<table>
						...
						<tbody>
							<tr>
								...
								<td colspan="3" style="padding: 15px 0; text-align: justify; padding-left: 15px;"><input id="subject" name="preTitle" type="text" size="100" /></td>
							</tr>
							<tr>
								<td style="background-color: rgb(244,244,244);">내용</td>
								<td colspan="3" style="text-align: justify; padding-left: 15px;"><textarea id="content" name="preContent" cols="104" rows="12" placeholder=" 내용을 입력하세요" ></textarea></td>
							</tr>
							<tr>
								<td style="background-color: rgb(244,244,244);">첨부파일</td>
								<td colspan="3" style="text-align: left; padding-left: 15px;"><input type="file" name="attach" /></td>
							</tr>
							<tr style="border: none;">
								<td colspan="4" style="border: none; padding: 50px 0;"><span class="writeBtn" id="btnWrite">등록</span>&nbsp;&nbsp;&nbsp;<span class="writeBtn" onclick="javascript:history.back();">취소</span></td>
							</tr>
						</tbody>
					</table>
