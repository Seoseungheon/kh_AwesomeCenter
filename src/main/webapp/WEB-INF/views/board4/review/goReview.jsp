...
<link rel="stylesheet" type="text/css" href="<%=ctxPath%>/resources/css/goReview.css" />
...
<script type="text/javascript">
	...
	//	var teacher_name = $("#teacher_name").siblings("td").child("select").child("input").val();
		...
		$("#registerBtn").click(function() {
			...
			// 수강후기 강좌
			var reviewVal = $("select[name=reviewLecNo]").val().trim();
			if(reviewVal == ""){
				alert("후기를 작성할 강좌를 선택하세요!");
				return;
			}
...
/* 	        === 스마트 에디터 구현 끝 === */
		...
		/* 	=== 스마트에디터 구현 시작 === */
		    ...
		    */    
			...
			frm.method = "POST";
			frm.action = "<%= ctxPath%>/addReview.to";
			frm.submit();
...
<body id = "question_body">
   ...
   <div id = "question_container" >
      ...
      <div id = "question_div">
         ...
         <table class="table" id="question_table">
               <tr>      
                  <th>수강강좌</th>
                  <td>
                  	<select class="questionCategory" name="reviewLecNo" id="class_name" style = "margin: 3.5%;" >  
                  ...
                  <th>강사명</th>
                  <td style="padding-left:15px; vertical-align: middle;" id = "teacher_name"></td>
               </tr>
               ...
               <tr>
                ...
                <tr>       
                  ...
                  <td colspan="3" style = "padding-left: 19px;">
                  	<textarea maxlength="1000" name="content" id="content" placeholder="자유롭게 회원님의 수강후기를 작성해주세요!"></textarea>
                  </td>
               </tr>
                <tr>      
                  <th>첨부파일</th>
      ...
      <div id="btnArea">
      	<div id="leftArea">
      		<button type="button" class="btns" id="listBtn" onclick="<%= ctxPath%>/board.to">목록</button>
      	</div>
      	<div id="rightArea">
      		<button type="reset" class="btns" id="resetBtn">취소</button>
