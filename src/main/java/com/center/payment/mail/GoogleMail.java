...
import com.center.payment.mail.MySMTPAuthenticator;
...
public class GoogleMail {
    ...
    public void sendmail(String recipient, String emailContents)  
    	...
    	prop.put("mail.smtp.user", "보내는 사람의 메일주소");
    	...
    	// 제목 설정
    	String subject = "[ 으뜸문화센터 ] 회원님의 결제 내역을 알려드립니다.";
    	msg.setSubject(subject);
    	        
    	// 보내는 사람의 메일주소
    	String sender = "보내는 사람의 메일주소";
    	...
    	msg.setContent("<div style = \"width : 800px; padding : 20px; 50px;\">"+emailContents+"</div>", "text/html;charset=UTF-8");
 ...
 // ==== Spring Scheduler(스프링 스케줄러)를 사용한 email 발송하기 예제 ==== //
    public void sendmail_Reservation(String recipient, String emailContents)
    	...
    	// 제목 설정
    	String subject = "localhost:9090/board/ 방문 예약일자 입니다. ";
    	msg.setSubject(subject);
    	        
    	// 보내는 사람의 메일주소
    	String sender = "noehhhhe@gmail.com";
    	Address fromAddr = new InternetAddress(sender);
    	msg.setFrom(fromAddr);
