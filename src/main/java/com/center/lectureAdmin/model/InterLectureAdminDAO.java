...
public interface InterLectureAdminDAO {
	...
	// 7. 강좌별 대기자 리스트 조회
	List<LectureStudentVO> getWaitingtList(String classno_fk);
	...
	// c. 이벤트 상세 내역 조회
	EventBoardVO getEventInfo (String event_seq);
	
	// c-1. 조회수+1
	void setAddViewCount(String event_seq);
